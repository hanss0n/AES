...
private:
    ...
    std::array<unsigned char, 16> cipher_key; //Cipher key
    std::array<unsigned char, 176> expanded_key{};
    std::array<unsigned char, 16> state{};
    int KEY_SIZE = 16;
    int BLOCK_SIZE = 16;

    std::array<unsigned char, 256> substitution_box = {
    ...
    std::array<unsigned char, 256> mult_2 = {
    ...
    std::array<unsigned char, 256> mult_3 = {
    ...
    std::array<unsigned char, 256> rcon = {
